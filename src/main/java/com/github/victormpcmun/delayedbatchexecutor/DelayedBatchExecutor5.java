...
import com.github.victormpcmun.delayedbatchexecutor.callback.BatchCallBack5;
...
/**
 * Delayed Batch Executor for four arguments (of types A,B,C and D) and return type Z
 * <br>
 * <pre>
 * {@code
 * DelayedBatchExecutor5<String,Integer,Integer,Integer> dbe = DelayedBatchExecutor5.create(Duration.ofMillis(50), 10, this::myBatchCallback);
 *
 * ...
 *
 ...
 *    String stringResult = dbe.execute(param1, param2, param3,param4); // the thread will be blocked until the result is available
 ...
 *
 *    // using Mono
 *    Mono<String> stringResult = dbe.executeAsMono(param1, param2, param3, param4); // the thread will not  be blocked
 *    // compute something else
...
public class DelayedBatchExecutor5<Z,A,B,C,D> extends DelayedBatchExecutor {
    ...
    public static <Z,A,B,C,D> DelayedBatchExecutor5<Z,A,B,C,D> create(Duration duration, int size, BatchCallBack5<Z,A,B,C,D> batchCallback5) {
        return new DelayedBatchExecutor5<>(duration, size, getDefaultExecutorService(), getDefaultBufferQueueSize(), batchCallback5);
    }
     ...
     * <br>
     * <br>
     * It will throw any {@link RuntimeException} thrown inside of the  {@link BatchCallBack5 }
     * <br>
     ...
     * It will throw a {@link RuntimeException} if the internal buffer Queue of this Delayed Batch Executor is full.
     * <br>
     * If  a {@link RuntimeException} is thrown inside of the  {@link BatchCallBack5 }, then it will be the cause of the checked Exception  {@link ExecutionException}  thrown by  {@link Future#get()} as per contract of {@link Future#get()}
     * <br>
     * <br>
     * @param  arg1 value of the first argument of type A defined for this Delayed Batch Executor
     * @param  arg2 value of the second argument of type B defined for this Delayed Batch Executor
     ...
     * It will throw a {@link RuntimeException} if the internal buffer Queue of this Delayed Batch Executor is full.
     * <br>
     * If a {@link RuntimeException} is thrown inside of the  {@link BatchCallBack5}, then it will be the propagated as any {@link RuntimeException } thrown from <a href="https://projectreactor.io/docs/core/release/api/reactor/core/publisher/Mono.html">Mono</a>
     * <br>
     * <br>
     * @param  arg1 value of the first argument of type A defined for this Delayed Batch Executor
     * @param  arg2 value of the second argument of type B defined for this Delayed Batch Executor
